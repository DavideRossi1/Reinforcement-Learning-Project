...
EXPORTPOLICYNAME="smallcar_boost3_diff100.txt"

# String, or 0. If you want to save the scores in a file, set with the name of the file. 
# Otherwise, set with 0:              
SAVESCORESNAME="smallcar_boost3_diff100.txt"                    
...
NGAMES=3000         # number of games to be played (used for training purposes, not for plotting)
