...
SPEED=5            # starting speed of both you and the enemy cars
...
COUNTER=10000000   # number of points to be scored before increasing the speed of the enemy cars, hence increasing the difficulty

ENVSIZE=(100,100)  # height and width of the environment
CARSIZE=(25,20)    # height and width of the cars. A good choice to have something realistic is ~1/4 of the height and ~1/6 of the width of the environment
...
SAVESCORESNAME=0                         # If you want to save the scores in a file, set with the name of the file. Otherwise, set with 0
...
GAMMA=1            # discount factor for temporal difference learning
LEARNING_RATE=0.01 # learning rate for temporal difference learning
EPSILON=0.5        # epsilon used for the epsilon-greedy policy
EPSDECAY=0.90      # epsilon decay factor: the epsilon used for the epsilon-greedy policy is multiplied by this factor at each step
